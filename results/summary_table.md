...
| transformer | NB-BERT-base + chunk-and-pool | max_len=512, stride=256 | 5 | 0.9054 ± 0.0020 | 0.8623 ± 0.0022 | 0.7854 ± 0.0032 | 0.9393 ± 0.0014 |  |
...
| LLM (few-shot) | Llama-3.1-8B-Instruct | few-shot, k=8 | 1 | 0.9136 | 0.8758 | 0.8072 | 0.9443 | 500 |
| LLM (few-shot) | Llama-3.1-8B-Instruct | few-shot, order=1 | 1 | 0.9076 | 0.8728 | 0.8064 | 0.9393 | 8 |
| LLM (few-shot) | Llama-3.1-8B-Instruct | few-shot, order=2 | 1 | 0.9131 | 0.8803 | 0.8176 | 0.9430 | 12 |
| LLM (few-shot) | Llama-3.1-8B-Instruct | few-shot, order=3 | 1 | 0.9076 | 0.8728 | 0.8064 | 0.9393 | 8 |
